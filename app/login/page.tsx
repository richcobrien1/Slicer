      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900">3D Slicer</h1>
            <p className="text-gray-600 mt-2">AI-Powered 3D Model Creator</p>
          </div>
        ...
        <p className="text-center text-white text-sm mt-6">
          Create 3D models with AI • Voice & Chat Interface
        </p>
      </div>
    </div>
  );
